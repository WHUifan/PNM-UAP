...
import torch
from torchvision.models import resnet18,vgg19,vgg16,resnet34,resnet152,googlenet,alexnet,vgg16_bn,vgg19_bn,resnet50,resnet101
...
def validate_arguments(test_model):
    models = ['vgg16', 'vgg19', 'googlenet', 'alexnet', 'resnet152','resnet18','resnet34','vgg16_bn','vgg19_bn','resnet50','resnet101']
    ...
    if initialize == True:
        if args.val_dataset_name == 'imagenet':
            args.all_model = [torchvision.models.alexnet(pretrained=True), torchvision.models.vgg16(pretrained=True),
                              ...
                              torchvision.models.googlenet(pretrained=True),torchvision.models.vgg16_bn(pretrained=True),
                              torchvision.models.vgg19_bn(pretrained=True),torchvision.models.resnet50(pretrained=True),
                              torchvision.models.resnet101(pretrained=True)]
            args.all_model_name = ['alexnet', 'vgg16', 'vgg19', 'resnet152', 'googlenet','vgg16_bn','vgg19_bn','resnet50','resnet101']
            args.delta_size = 224
